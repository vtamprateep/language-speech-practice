...
def test_returns_list_of_ids():
    ...
    result = ExponentialSRSPolicy.retrieve_items(items, N=2)
...
def test_threshold_filters_out_high_scores():
    ...
    result = ExponentialSRSPolicy.retrieve_items(items, score_threshold=10, N=2)
...
def test_returns_empty_if_all_filtered():
    ...
    result = ExponentialSRSPolicy.retrieve_items(items, score_threshold=1, N=5)
